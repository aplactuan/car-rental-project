...
class UpdateTripReportRequest extends FormRequest
{
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator): void {
            $tripReport = $this->route('tripReport');

            if (! $tripReport instanceof TripReport) {
                return;
            }

            $timeIn = $this->input('time_in', $tripReport->time_in);
            $timeOut = $this->input('time_out', $tripReport->time_out);
            ...
            $odometerIn = $this->input('odometer_in', $tripReport->odometer_in);
            $odometerOut = $this->input('odometer_out', $tripReport->odometer_out);
