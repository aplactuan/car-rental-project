...
interface TransactionRepositoryInterface
{
    ...
    /**
     * @param  array{has_bill?: bool, po_number?: string}  $filters
     ...
     *
     * @param  array{user_id: int, customer_id: string, name: string, po_number?: string|null, bookings?: array<int, array{car_id: string, driver_id: string, note?: string, start_date: string, end_date: string}>}  $data
     * @return Transaction
     */
